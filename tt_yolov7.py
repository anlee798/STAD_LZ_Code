...
from utils.misc import CollateFunc, build_dataset, build_dataloader, MyCollateFunc
...
def parse_args():
    ...
    # Model
    parser.add_argument('-v', '--version', default='yowo_v2_TSM', type=str, #yowo_v2_tiny
                        help='build YOWOv2')
