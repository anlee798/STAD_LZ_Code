    ...
    def __init__(self, 
                ...
                for k in list(checkpoint_state_dict.keys()):
                    if k in model_state_dict:
                        ...
                        if shape_model != shape_checkpoint:                            
                            print("2D-Backbone: k in model_state_dict",k)
                            checkpoint_state_dict.pop(k)
                    else:
                        checkpoint_state_dict.pop(k)
                        print("2D-Backbone: k not in model_state_dict",k)
        ...
        if cfg['pretrained_3d']:
            ...
            if url is None:
                ...
                print('Loading 3D backbone pretrained weight: {}'.format("TSM:arch=MobileNetv2 1x"))
                ...
                for k in list(new_state_dict.keys()):
                    if k in model_state_dict:
                        ...
                        if shape_model != shape_checkpoint:
                            ...
                            print("3D-Backbone: k in model_state_dict",k)
                    else:
                        new_state_dict.pop(k)
                        print("3D-Backbone: k not in model_state_dict",k)
