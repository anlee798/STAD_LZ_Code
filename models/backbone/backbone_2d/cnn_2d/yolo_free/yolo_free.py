...
class FreeYOLO(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("pyramid_feats",pyramid_feats[0].shape) # torch.Size([1, 64, 28, 28])
        # print("pyramid_feats",pyramid_feats[1].shape) # torch.Size([1, 64, 14, 14])
        # print("pyramid_feats",pyramid_feats[2].shape) # torch.Size([1, 64, 7, 7])
